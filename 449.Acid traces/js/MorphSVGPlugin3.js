...
!(function (t, e) {
              ...
              "rect" === T
                  ...
                  ? ((l = "circle" === T ? (i = a = M.r) * b : ((i = M.rx), (a = M.ry) * b)),
                    (n =
                        ...
                        (o = M.cy) +
                        " C" +
                        [r + i, o + l, r + (h = i * b), o + a, r, o + a, r - h, o + a, r - i, o + l, r - i, o, r - i, o - l, r - h, o - a, r, o - a, r + h, o - a, r + i, o - l, r + i, o].join(",") +
                        "z"))
                  : "line" === T
                  ? (n = "M" + M.x1 + "," + M.y1 + " L" + M.x2 + "," + M.y2)
                  : ("polyline" !== T && "polygon" !== T) || ((n = "M" + (r = (c = (t.getAttribute("points") + "").match(N) || []).shift()) + "," + (o = c.shift()) + " L" + c.join(",")), "polygon" === T && (n += "," + r + "," + o + "z")),
    ...
    function stringToRawPath(t) {
        ...
        for (e = 0; e < v; e++)
            if (((p = i), isNaN(P[e]) ? (a = (i = P[e].toUpperCase()) !== P[e]) : e--, (r = +P[e + 1]), (o = +P[e + 2]), a && ((r += m), (o += w)), e || ((h = r), (l = o)), "M" === i))
                s && (s.length < 8 ? --_.length : (y += s.length)), (m = h = r), (w = l = o), (s = [r, o]), _.push(s), (e += 2), (i = "L");
            ...
            else if ("L" === i || "Z" === i) "Z" === i && ((r = h), (o = l), (s.closed = !0)), ("L" === i || 0.5 < k(m - r) || 0.5 < k(w - o)) && (yc(m, w, r, o), "L" === i && (e += 2)), (m = r), (w = o);
            else if ("A" === i) {
                if (
                    ((u = P[e + 4]),
                    (d = P[e + 5]),
                    ...
                    (g = P[e + 7]),
                    (n = 7),
                    1 < u.length && (u.length < 3 ? ((g = c), (c = d), n--) : ((g = d), (c = u.substr(2)), (n -= 2)), (d = u.charAt(1)), (u = u.charAt(0))),
    ...
    function U(t, e) {
        ...
        for (var n, r, o, i, a, s, h, l, c, g, f, p, u, d, P, _, m = t.length, w = t[0][0], v = w, y = t[0][1], x = y, M = 1 / e; -1 < --m; )
            for (n = (a = t[m]).length, i = 6; i < n; i += 6)
                for (c = a[i], g = a[i + 1], f = a[i + 2] - c, d = a[i + 3] - g, p = a[i + 4] - c, P = a[i + 5] - g, u = a[i + 6] - c, _ = a[i + 7] - g, s = e; -1 < --s; )
                    w < (r = ((h = M * s) * h * u + 3 * (l = 1 - h) * (h * p + l * f)) * h + c) ? (w = r) : r < v && (v = r), y < (o = (h * h * _ + 3 * l * (h * P + l * d)) * h + g) ? (y = o) : o < x && (x = o);
    ...
    function Z(t, e, n) {
        ...
        if (n) for (reverseSegment((r = t.slice(0))), i = 6; i < a; i += 6) (o = Y(r, e, i / 6, l, c)) < g && ((g = o), (f = -i));
        return f / 6;
    }
    function $(t, e, n) {
        for (var r, o, i, a, s, h, l = t.length, c = 1e20, g = 0, f = 0; -1 < --l; ) for (h = (r = t[l]).length, s = 0; s < h; s += 6) (o = r[s] - e), (i = r[s + 1] - n), (a = w(o * o + i * i)) < c && ((c = a), (g = r[s]), (f = r[s + 1]));
        return [g, f];
    }
    ...
    function ba(t, e, n, r, o) {
        var i,
            ...
            x = "log" === n;
        if (u[0]) {
            if (1 < p.length && (t.sort(P), e.sort(P), p.size || U(p), u.size || U(u), (c = p.centerX - u.centerX), (g = p.centerY - u.centerY), P === W)) for (w = 0; w < u.length; w++) p.splice(w, 0, _(u[w], p, w, m, c, g));
            if (f)
                for (f < 0 && (f = -f), p[0].length > u[0].length && aa(u[0], ((p[0].length - u[0].length) / 6) | 0), w = u.length; d < f; )
                    p[w].size || T(p[w]), (h = (s = $(u, p[w].centerX, p[w].centerY))[0]), (l = s[1]), (u[w++] = [h, l, h, l, h, l, h, l]), (u.totalPoints += 8), d++;
                ...
                (i = e[w]),
                    ...
                    (n = v[w] || 0 === v[w] ? v[w] : "auto") &&
                        (a.closed || (Math.abs(a[0] - a[a.length - 2]) < 0.5 && Math.abs(a[1] - a[a.length - 1]) < 0.5)
                            ? "auto" === n || "log" === n
                                ? ((v[w] = n = Z(a, i, !w || !1 === o)), n < 0 && ((y = !0), reverseSegment(a), (n = -n)), X(a, 6 * n))
                                : "reverse" !== n && (w && n < 0 && reverseSegment(a), X(a, 6 * (n < 0 ? -n : n)))
                            : !y &&
                              (("auto" === n &&
    ...
    function ea(t, e) {
        ...
        for (n = (0.5 * e) / (0.5 * (o = t.length) - 1), r = 0; r < o - 2; r += 2) {
            if (((l += n), (s = parseFloat(t[r + 2])), (h = parseFloat(t[r + 3])), 0.999999 < l))
                for (a = 1 / (Math.floor(l) + 1), i = 1; 0.999999 < l; ) (f += (c + (s - c) * a * i).toFixed(2) + "," + (g + (h - g) * a * i).toFixed(2) + " "), l--, i++;
            (f += s + "," + h + " "), (c = s), (g = h);
        }
        return f;
    }
    ...
    function ia(t, e) {
        for (var n, r, o, i, a, s, h, l, c, g, f, p, u = t.length, d = 0.2 * (e || 1); -1 < --u; ) {
            for (f = (r = t[u]).isSmooth = r.isSmooth || [0, 0, 0, 0], p = r.smoothData = r.smoothData || [0, 0, 0, 0], f.length = 4, l = r.length - 2, h = 6; h < l; h += 6)
                (o = r[h] - r[h - 2]),
                    (i = r[h + 1] - r[h - 1]),
                    (a = r[h + 2] - r[h]),
                    (s = r[h + 3] - r[h + 1]),
                    (c = v(i, o)),
                    (g = v(s, a)),
                    (n = Math.abs(c - g) < d) && ((p[h - 2] = c), (p[h + 2] = g), (p[h - 1] = w(o * o + i * i)), (p[h + 3] = w(a * a + s * s))),
                    f.push(n, n, 0, 0, n, n);
            r[l] === r[0] &&
                r[1 + l] === r[1] &&
                ((o = r[0] - r[l - 2]),
                ...
                (c = v(i, o)),
                (g = v(s, a)),
                Math.abs(c - g) < d && ((p[l - 2] = c), (p[2] = g), (p[l - 1] = w(o * o + i * i)), (p[3] = w(a * a + s * s)), (f[l - 2] = f[l - 1] = !0)));
        }
        return t;
    }
    function ja(t) {
    ...
    function ma(t, e, n, r) {
        ...
        return (
            ...
            (this._anchorPT = I = { _next: this._anchorPT, t: t, sa: g, ca: r && i * r.ca < 0 && Math.abs(i) > d ? o : i, sl: c, cl: w(h * h + l * l) - c, i: n })
        );
    }
    function na(t) {
    ...
    var o,
            ...
            for (
                setTimeout(function () {
                    window &&
                        ...
                        (console.log(P(37, 99, 87, 97, 114, 110, 105, 110, 103), P(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 51, 48, 112, 120, 59, 99, 111, 108, 111, 114, 58, 114, 101, 100, 59)),
                        console.log(
                            P(65, 32, 116, 114, 105, 97, 108, 32, 118, 101, 114, 115, 105, 111, 110, 32, 111, 102, 32) +
                                i +
                                P(
                                    32,
                                    105,
                        ...
                        console.log(
                            ...
                            P(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 49, 54, 112, 120, 59, 99, 111, 108, 111, 114, 58, 35, 52, 101, 57, 56, 49, 53)
                        ),
        ...
        K = {
                ...
                if (
                    ...
                    if (
                        ...
                        for (
                            ...
                            for (w = u[_], v = d[_], f = w.isSmooth || [], p = v.isSmooth || [], m = w.length, P = I = 0; P < m; P += 2)
                                (v[P] === w[P] && v[P + 1] === w[P + 1]) ||
                                    (S
                                        ? f[P] && p[P]
                                            ? ((x = w.smoothData),
                                        ...
                                        : ((s = this.add(w, P, w[P], v[P])), (s = this.add(w, P + 1, w[P + 1], v[P + 1]) || s)));
            ...
            render: function render(t, e) {
                ...
                if (1 === t && e._apply) for (w = e._pt; w; ) w.end && (e._prop ? (m[e._prop] = w.end) : m.setAttribute(w.endProp, w.end)), (w = w._next);
                else if (u) {
                    ...
                    if (((m._gsRawPath = u), e._apply)) {
                        for (n = "", h = 0; h < u.length; h++) for (i = (o = u[h]).length, n += "M" + ((o[0] * _) | 0) / _ + " " + ((o[1] * _) | 0) / _ + " C", s = 2; s < i; s++) n += ((o[s] * _) | 0) / _ + " ";
