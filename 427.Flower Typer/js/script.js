...
function init() {
    ...
    const flowerTexture = new THREE.TextureLoader().load('../../427.Flower Typer/img/flower.png');
    ...
    const leafTexture = new THREE.TextureLoader().load('../../427.Flower Typer/img/leaf.png');
