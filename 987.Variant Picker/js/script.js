...
resizeContainer.addEventListener('input', event => {
  ...
  if (config.style === 'hop') {
    ...
    if (newCurrentIndex !== undefined && radios[newCurrentIndex]) {var _radios$newCurrentInd;
    ...
    if (newPreviousIndex !== undefined && radios[newPreviousIndex]) {var _radios$newPreviousIn;
