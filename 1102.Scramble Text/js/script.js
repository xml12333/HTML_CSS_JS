import { animate, createTimer, createTimeline, scrambleText, $ } from 'https://esm.sh/animejs';
import { createTweaks, syncTweaks, Float, Int, Str, Bool, Select, registerType, registerTypeGUI } from 'https://esm.sh/tweaks';
import { GUI } from 'https://esm.sh/tweaks/gui';
